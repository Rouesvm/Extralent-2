...
import com.extralent.common.config.OregenConfig;
...
public class OreGenerator implements IWorldGenerator {
    public static final String RETRO_NAME = "ExtralentOreGen";
    ...
    public void generateWorld(Random random, int chunkX, int chunkZ, World world, boolean newGen) {
        ...
        if (world.provider.getDimension() == DimensionType.OVERWORLD.getId()) {
            if (OregenConfig.GENERATE_OVERWORLD) {
                addOreSpawn(ModBlocks.rydrixOre, (byte) OreType.ORE_OVERWORLD.ordinal(), Blocks.STONE, world, random, chunkX * 16, chunkZ * 16,
