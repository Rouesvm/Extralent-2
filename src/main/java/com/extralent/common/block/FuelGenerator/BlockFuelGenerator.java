...
public class BlockFuelGenerator extends MachineBlock implements ITileEntityProvider {
    ...
    public BlockFuelGenerator(String name) {
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
        ...
        if (tileEntity instanceof TileFuelGenerator) {
            return state.withProperty(STATE, ((TileFuelGenerator) tileEntity).getState());
        }
        return super.getActualState(state, world, pos);
    }

    @Override
    public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer, EnumHand enumHand) {
